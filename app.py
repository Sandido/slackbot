...
# TODO app is not returning a good challenge to the slack api challenege. 
# challenge is to /slack/events, so the last thing to try is ensure this code
# is run on app startup. Renamed it to try and get picked up 
# automatically as the startup file. 
app = Flask(__name__)
